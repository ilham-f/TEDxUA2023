        ...
        <div className="bg-[url('../../../public/assets/bg-grass.jpg')] bg-no-repeat bg-cover pt-10 pb-24 w450:pt-44 w450:pb-44 grid justify-center px-8 w-full">
            ...
            <div className='border-4 rounded-3xl backdrop-blur-[2px] px-4 pt-8 md:px-16 md:pt-10 w-[280px] xs:w-[340px] md:w-[600px] lg:w-[800px]'>
                ...
                <div className='flex justify-center gap-1 mt-3 mb-20 md:mb-44'>
                    <span className='font-gooddog text-white text-[20px] md:text-[25px]'>Already Have An Account?</span>
                    <button className='bg-[#fff] rounded-full text-[#A4161A] text-[16px] md:text-[20px] px-[12px] font-gooddog hover:text-white hover:bg-[#A4161A] transition-all underline' type='button'>LOGIN</button>
                </div>
