    ...
    return (
        ...
        <Navbar/>
            ...
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
                <img className='xl:px-10 pb-16' src={mostSelectedBundle.image1} alt="Gambar Bundling" />
                <img className='xl:px-10 pt-26' src={mostSelectedBundle.image2} alt="Gambar Bundling" />
            </div>
            ...
            <span className="inline-block bg-[#A4161A] rounded-full text-[#FFFFFF]">
                <a
                href="https://forms.gle/y4Z57V9nhyH6Ch316"
