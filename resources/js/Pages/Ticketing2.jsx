...
export default function Ticketing2({page, setPage, data, setData, processing, submit, error}) {
  ...
  return (
    <>  
        ...
        {error ? ( 
            <div className="alert alert-danger font-capuchetrial text-white text-center lg:text-custom13 md:text-custom14 text-custom4">
                {error}
            </div>)
            :(
                <>
