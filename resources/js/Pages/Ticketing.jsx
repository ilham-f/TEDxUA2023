...
export default function Ticketing({tickets, setSelectedTicket, selectedTicket, page, setPage}) {
            ...
            <div className="min-h-screen bg-[url('/assets/bg-ticketing.jpg')] grid justify-items-center pt-10 md:pt-44 pb-20">
                ...
                <div>
                    <RadioGroup.Root
                        ...
                        defaultValue={selectedTicket.id}
                        aria-label="View density"
                        onValueChange={(value) => setSelectedTicket(tickets[value - tickets[0].id])}
                    >
