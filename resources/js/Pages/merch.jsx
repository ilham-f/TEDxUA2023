...
export default function Merch() {
    ...
    <div className="relative mx-auto bg-white xl:w-[1200px] lg:w-[900px] md:w-[600px] xs:w-[300px] md:rounded-[50px] xs:rounded-[15px] xl:mt-[250px] md:mt-[200px] xs:mt-[100px] md:py-[30px] xs:py-[15px]">
    <div className="">
    ...
    <div className="grid grid-cols-2 xl:gap-44 lg:gap-8 md:gap-4 xs:gap-4 md:px-10 xs:px-2">
      <div className="relative">
